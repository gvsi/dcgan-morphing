...
BASE_SCRIPT = [
    ...
    "    --input-type random_test \\",
    "    --num-input-images 10 \\",
    "    --num-measurements 25 50 100 200 300 400 500 \\",
    "    --noise-std 0.1 \\",
    "    --model-types nn lasso omp \\",
...
if __name__ == '__main__':
    ...
    HPARAM_NAMES_FOR_GRID_SEARCH = ['num-measurements']
    for hparam in HPARAM_NAMES_FOR_GRID_SEARCH:
        PARSER.add_argument('--' + hparam, metavar=hparam+'-val', type=str, nargs='+', default=None,
                            help='Values of ' + hparam)

    PARSER.add_argument('--scripts-base-dir', type=str, default='../scripts/', help='Base directory to save scripts: Absolute path or relative to src')
